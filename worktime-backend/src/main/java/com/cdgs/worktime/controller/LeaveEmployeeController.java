...
public class LeaveEmployeeController {
	...
	private ResponseEntity<ResponseDto<LeaveEmployeeDto>> getLeaveEmployee(@PathVariable(value = "year") Integer year,
		...
		try {
			...
			for (LeaveInformation leaveEmployeeResult : leaveEmployeeResults) {
				...
				leaveEmployeeList.add(new LeaveEmployeeDto(leaveName,
						leaveDate.parse(leaveEmployeeResult.getLeaveDate()), leaveEmployeeResult.getLeaveType()));
...
//	@GetMapping(path = "byDay/{year}/{month}/{day}")
//	public ResponseEntity<ResponseDto<LeaveEmployeeDto>> getLeaveEmployeeAllByDate(
//			@PathVariable(value = "year") Integer getYear, @PathVariable(value = "month") Integer getMonth,
//			@PathVariable(value = "day") Integer getDay) throws IOException, SQLException {
//		
//		//Section
//		Connection myConn = null;
//		Statement myStmt = null;
...
//
//			String convertTextDateStart = converDateCallService.format(startDate);
//			String converTextSDateEnd = converDateCallService.format(startDate);
//			System.out.println(convertTextDateStart);
//			long start = System.currentTimeMillis();
//			
//			myConn = DriverManager.getConnection("jdbc:mysql://10.254.40.203:3306/worktime?useSSL=false&characterEncoding=utf-8&serverTimezone=UTC","root", "root");
...
//	}
	...
	private ResponseEntity<ResponseDto<LeaveEmployeeDto>> getLeaveEmployeByday(
			@PathVariable(value = "month") Integer getmonth, @PathVariable(value = "year") Integer year,
			@PathVariable(value = "empNo") String empNo) {
