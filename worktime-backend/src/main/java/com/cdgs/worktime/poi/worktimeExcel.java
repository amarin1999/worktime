...
//	      );
		 ...
		 Connection connect = DriverManager.getConnection( 
	        ...
	        // Set month
	        String[] month = {"มกราคม", "กุมภาพันธ์", "มีนาคม", "เมษายน","พฤษภาคม","มิถุนายน","กรกฎาคม","สิงหาคม","กันยายน","ตุลาคม","พฤษจิกายน","ธันวาคม"};
	        ...
	        for(int indexOfMonth = 0; indexOfMonth < month.length; indexOfMonth++) {
	        	...
	        	if(getCalendar.next()) {
			        ...
			        if(year % 4 == 0) {
			        	sidework.addMergedRegion(new CellRangeAddress(0, 1, dayOfMonth29[indexOfMonth]+1, dayOfMonth29[indexOfMonth]+1));
			        	...
			        	sidework.addMergedRegion(new CellRangeAddress(0, 1, dayOfMonth28[indexOfMonth]+1, dayOfMonth28[indexOfMonth]+1));
		        ...
		        while(getName.next()){
		            ...
		            while(getDate.next()) {
		            	...
		            	if(getDate.getInt("id_employee") == getName.getInt("id_employee") && monthCurrent == checkMonth && checkYear == year) {
	        ...
	        try (FileOutputStream fos = 
	            new FileOutputStream(new File("worktimeExcel" + year + ".xlsx"))) {
	            workbook.write(fos);
